$(document).ready(function(){
   		...
   		function modalFunction(){
   			...
   			//$('#user_Id').val();
   			//$('#book_capacity).val();
   			$('#book_hanbok').val(hp/10000);
   			$('#book_breakfast').val(bp/10000);
   			$('#book_plusperson').val(pp/10000);
    	...
    	function optionChange(){
    		...
    		var bp = get_input3*10000;
    	  	$('#hp').text(get_input1*10000);
    	  	$('#pp').text(get_input2*10000);
    	  	$('#bp').text(get_input3*10000);
    	  	$("#optionPrice").text(Number(hp) + Number(pp) + Number(bp));
