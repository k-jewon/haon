...
<body class="bg-light">
	...
	<c:forEach var="pl" items="${mypayList}">
		<form method="post" action="/resetpay">
		<hr class="mb-6">
		<div class="row">
		<div class="col-md-6 mb-3"><span class="text-muted">${pl.room_name}</span></div>
		<h5 class="col-md-6 mb-3 text-right"><span class="badge badge-primary">결제됨</span></h5>
		</div>
		<div class="row">
		<div class="col-md-6 mb-3"><span class="text-muted">${pl.user_name}</span></div>
		<div class="col-md-6 mb-3 text-right"><span class="text-muted">(예약날짜)</span></div>
		</div>
		<div class="row">
		<div class="col-md-6 mb-3"><span class="text-muted">${pl.pay_price}원</span></div>
